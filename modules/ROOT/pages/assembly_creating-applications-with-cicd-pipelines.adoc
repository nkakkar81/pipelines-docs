...
The following section demonstrates how to create pipelines, add triggers and run them, and check on the application status using the pipeline-tutorial example.
...
include::proc_defining_and_adding_triggers.adoc[leveloffset=+1]

include::proc_create_webhooks.adoc[leveloffset=+1]
...
* For more details on pipelines in the *Developer* perspective, see the link:https://openshift.github.io/pipelines-docs/docs/0.10.5/assembly_working-with-pipelines-using-the-developer-perspective.html[working with pipelines in the *Developer* perspective].
